...
const projects = [
    {
        ...
        category: "frontend",
        title: "project 1",
        description: "Lorem Ipsum dolot sit",
                ...
                <div className="flex flex-col xl:flex-row xl:gap-[30px]">
                    <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
                        <div className="flex flex-col gap-[30px] h-[50%*]">
                            ...
                            <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent transition-all duration-500 capitalize">{projects.category} project</h2>
                    ...
                    <div className="w-full xl:w-[50%]">
                        ...
                        >
                            ...
                            <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-[40px] z-20 w-full justify-between xl:w-max xl:justify-none"
