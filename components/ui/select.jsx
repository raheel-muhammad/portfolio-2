...
const SelectTrigger = React.forwardRef((props, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[48px] w-full items-center justify-between rounded-md border border-white/10  px-4 py-5 text-base placeholder:text-white/10 bg-primary focus:border-accent text-white/60 outline-none",
      props.className
    )}
    {...props}
  >
